...
export type MedicineMasterRow = {
  ...
  costPricePkr?: number;
  minSalePricePkr?: number;
  maxRetailPricePkr?: number;
  taxPct?: number;
  extraTaxPct?: number;
...
export type MedicineMasterDetail = MedicineMasterRow & {
  ...
  refs?: {
    ...
    category?: { id: string; code: string; name: string; parentId?: string | null } | null;
...
export type CompanyRow = {
  ...
  salesmanCommissionPct?: number;
  showForAdvTax?: string | null;
  productPolicyJson?: string | null;
  discountPolicyJson?: string | null;
  companyShiftingJson?: string | null;
  status: string;
  notes?: string | null;
};
...
export type TradeCustomerRow = {
  ...
  monthlySalesTargetPkr?: number;
  modeOfPayment?: string | null;
  timing?: string | null;
  visitFrequency?: number;
  visitingDaysJson?: string | null;
  termsOfPayment?: string | null;
  license9No?: string | null;
  license9Expiry?: string | null;
  license10No?: string | null;
  license10Expiry?: string | null;
  license11No?: string | null;
  license11Expiry?: string | null;
  advTaxType?: string | null;
  isFocCustomer?: boolean;
  canDeductTax?: boolean;
  taxPct?: number;
  imageUrl?: string | null;
  discountPolicyJson?: string | null;
  bonusPolicyJson?: string | null;
  companyCreditLimitsJson?: string | null;
  companyIdsJson?: string | null;
  blockSalesJson?: string | null;
  othersJson?: string | null;
