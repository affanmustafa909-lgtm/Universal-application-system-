...
export function recordDeviceInstall(
  systemType: string | null | undefined,
  preferredFrontendId?: BusinessSystemId | null,
): DeviceInstall | null {
  let systemId = businessSystemIdFromSystemType(systemType);
  if (systemId === "restaurant" && preferredFrontendId === "ice-cream-bar") {
