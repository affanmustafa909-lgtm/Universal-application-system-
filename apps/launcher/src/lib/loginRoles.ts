...
export function loginRolesForSystem(systemId: BusinessSystemId): {
  ...
  if (systemId === "ice-cream-bar") {
    return {
      admin: {
        id: "admin",
        label: "Admin",
        description: "Ice cream bar, users, menu, and full POS control",
        demoEmail: DEMO_ADMIN_EMAIL_BY_SYSTEM["ice-cream-bar"],
      },
...
export function loginPathForRole(role: PopsRole, systemId?: BusinessSystemId | null): string {
