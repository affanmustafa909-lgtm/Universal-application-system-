...
export function PopsDashboardPage(): JSX.Element {
  ...
  return (
    <div className="space-y-8">
      <PageHeader
        ...
        actions={
          <div className="flex flex-wrap items-center gap-2">
            <button
              type="button"
              className="rounded-lg border border-[var(--line)] bg-[var(--card)] px-2 py-1.5 text-xs font-semibold text-[color:var(--ink)] hover:bg-[var(--brand-cream)]"
            ...
            <Link
              to="/pops/closing"
              className="rounded-lg bg-[var(--brand)] px-3 py-2 text-xs font-semibold text-[color:var(--brand-fg,var(--ink))] hover:bg-[var(--brand-dark)]"
            >
              End of day
            </Link>
          </div>
      ...
      <div className="rounded-xl border border-[var(--line)] bg-white p-3 shadow-card dark:border-slate-800 dark:bg-slate-900/40">
        <div className="mb-2 flex flex-wrap items-center justify-between gap-2">
          <div>
            <h2 className="text-xs font-semibold uppercase tracking-wide text-[var(--ink)] dark:text-slate-300">Date &amp; time filter</h2>
          ...
          <>
            ...
            {topProducts.length > 0 ? (
              <section className="mt-6">
                ...
                <div className="mt-3 overflow-x-auto rounded-xl border border-[var(--line)] bg-white shadow-card dark:border-slate-800">
                  <table className="w-full text-left text-xs">
                    <thead className="bg-[var(--brand-cream)] text-[var(--muted)] dark:bg-slate-900/60">
                      <tr>
