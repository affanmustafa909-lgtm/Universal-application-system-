...
export function SystemSelectPage(): JSX.Element {
  ...
  // Single-system installers, and pharmacy/store device locks, skip the picker.
  // Restaurant-family locks still show Restaurant + Ice Cream Bar in suite.
  if (lockedSystemId && (isSingleSystemEdition() || !isRestaurantFamilySystem(lockedSystemId))) {
    return (
      <Navigate
