...
```
backend-system/api/  → NestJS API (host this online)
apps/
...
3. Set env vars (see [backend-system/RAILWAY.md](./backend-system/RAILWAY.md))
...
Full guide: **[backend-system/RAILWAY.md](./backend-system/RAILWAY.md)**
