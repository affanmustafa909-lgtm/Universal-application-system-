@echo off
setlocal
REM Build POPS Waiter APK (waiter-only login) against the local API.
...
echo Building Waiter APK from %POPS_BUILD_ROOT%...
...
echo Waiter: waiter1@platform.local / changeme-please-01  PIN 1111  branch ISB-GT
endlocal
